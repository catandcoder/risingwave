...
use crate::nexmark::{
    NexmarkSplit, NEXMARK_CONFIG_MAX_CHUNK_SIZE, NEXMARK_CONFIG_MIN_EVENT_GAP_IN_NS,
    NEXMARK_CONFIG_TABLE_TYPE, NEXMARK_CONFIG_USE_REAL_TIME, NEXMARK_MAX_FETCH_MESSAGES,
};
...
impl SplitReader for NexmarkSplitReader {
        ...
        Self: Sized,
    {
        ...
        let max_chunk_size = properties
            .get_nexmark(NEXMARK_CONFIG_MAX_CHUNK_SIZE)
            .unwrap_or_else(|_| NEXMARK_MAX_FETCH_MESSAGES.to_string())
            .parse::<u64>()
            .map_err(|e| anyhow!(e))?;
